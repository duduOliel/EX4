...
void main()
{
	...
	apple.setQuantity(CARROT_QUANTITY);
	...
	carrot.setQuantity(CARROT_QUANTITY);
	...
	cheese.setQuantity(CHEESE_QUANTITY);
	...
	icecream.setQuantity(ICECREAM_QUANTITY);

	// Printing icecream details
	cout << icecream;

	// Adding icecream  to the store
	...
	almostHealthyPackage.setQuantity(PACKAGE_QUANTITY);
